...
public class SecondaryProcess {
	...
	public SecondaryGoodsModel getSecondaryGoods( Long id) {
		SecondaryGoodsModel model = new SecondaryGoodsModel();
		if(id==null) {
			model.setCode(HttpCodeEnum.ERROR.getCode());
	...
	public SimpleFlagModel createSecondaryGoods(SecondaryGoodsParam param) {
		...
		SecondaryGoodsDTO dto = new SecondaryGoodsDTO();
		ResponseDO responseDO = secondaryService.createSecondaryGoods(dto);

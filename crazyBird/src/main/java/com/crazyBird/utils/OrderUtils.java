...
public class OrderUtils {
	 ...
	 * 订单类别头
	 */
	private static final String ORDER_CODE = "1";// 退货类别头
	private static final String RETURN_ORDER = "2";// 退款类别头
	private static final String REFUND_ORDER = "3";// 未付款重新支付别头
	private static final String AGAIN_ORDER = "4";// 随即编码
